  ...
  return (
    <>
      {formState === 0 && (
        ...
        >
          <div className="md:flex md:flex-row-reverse md:bg-white md:w-5/6 xl:w-8/12 2xl:w-9/12 md:m-auto md:justify-between md:p-4 md:rounded-2xl items-center md:gap-10">
